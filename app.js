...
app.get("/",(req,res)=>{
  res.render("home",{paraSend : homeStartingContent,posts : posts })

})

app.get("/about",(req,res)=>{
  res.render("about",{paraSend : aboutContent})
})

app.get("/contact",(req,res)=>{
  res.render("contact",{paraSend : contactContent})
})
...
app.post("/compose",(req,res)=>{
  ...
  const post = {
   title : req.body.textDataTitle,
   contant : req.body.textDataBody
  }
  posts.push(post)
  res.redirect("/")
})
